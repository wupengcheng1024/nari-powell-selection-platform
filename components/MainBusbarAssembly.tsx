...
const MainBusbarAssembly: React.FC<MainBusbarAssemblyProps> = ({ onPrev, onNext }) => {
  const [cabinets, setCabinets] = useState([
    { id: '1G1', name: '进线柜', img: 'images/assembly/1G1.png', spacing: 0 },
    { id: '1G2', name: '馈线柜', img: 'images/assembly/1G2.png', spacing: 0 },
    { id: '1G3', name: '馈线柜', img: 'images/assembly/1G3.png', spacing: 0 },
    { id: '1G4', name: '联络柜', img: 'images/assembly/1G4.png', spacing: 0 },
    { id: '1G5', name: 'PT柜', img: 'images/assembly/1G5.png', spacing: 0 },
    { id: '1G6', name: '计量柜', img: 'images/assembly/1G6.png', spacing: 0 },
  ]);
            ...
            <div className="flex-1 overflow-x-auto flex items-center">
                <div className="flex gap-6 mx-auto p-4 min-w-max justify-start">
                    ...
                    <div key={cabinet.id} className="w-64 flex flex-col gap-2 group shrink-0">
                        ...
                        <div className="bg-slate-50 border-2 border-slate-200 rounded-xl p-4 aspect-[2/3] flex items-center justify-center relative group-hover:border-blue-400 transition-all bg-white shadow-sm">
                            <img 
                            src={cabinet.img} 
                            alt={cabinet.name} 
