            ...
            <div className="space-y-4">
              ...
              <div className="pt-6">
                <button
                  ...
                  className="w-full py-3.5 xxxx-bg text-white rounded-xl font-bold shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition active:scale-[0.98] flex items-center justify-center gap-2"
                >
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-8 rounded-3xl shadow-2xl text-white relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-[10px] text-white/40">Generated by Xxxx AI</span>
              </div>
