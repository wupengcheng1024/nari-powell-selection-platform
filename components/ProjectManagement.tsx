  ...
  return (
    <div className="p-8 space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-wrap gap-4 items-center justify-between bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <button onClick={handleAddProject} className="px-6 py-2 xxxx-bg text-white rounded-xl text-sm font-bold shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition flex items-center gap-2">
              ...
              <tr key={p.id} className="hover:bg-slate-50 transition group">
                ...
                <td className="px-8 py-5 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <button onClick={() => onSelectProject(p.id)} className="px-4 py-1.5 xxxx-bg text-white rounded-lg text-xs font-bold hover:bg-blue-700">进入工作流</button>
                    {/* Approve Button */}
          ...
          <div className="bg-white w-full max-w-lg rounded-2xl shadow-xl relative z-10 animate-in zoom-in-95 overflow-hidden">
            ...
            <form onSubmit={(e) => {
              ...
              <div className="pt-4 flex justify-end gap-3">
                ...
                <button type="submit" className="px-4 py-2 xxxx-bg text-white rounded-lg text-sm font-bold hover:bg-blue-700">保存项目</button>
              </div>
            </form>
          </div>
        </div>
